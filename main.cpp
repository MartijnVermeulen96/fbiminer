...
int main(int argc, char *argv[])
{
    if (argc != 4)
    {
        std::cout << "Usage: ./Cleaner infile tau repair" << std::endl;
        std::cout << "\t where infile is a .csv dataset with headers, and tau a value in ]0, 0.75[, and repair a boolean 1/0" << std::endl;
    }
    else
    {
        // parse arguments
